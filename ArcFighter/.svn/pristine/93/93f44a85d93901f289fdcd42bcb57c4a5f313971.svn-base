...
procedure PutImage(x1,y1:smallint; var bitmap; bit:word); overload;
procedure PutImage(x1,y1:smallint; var bitmap); overload;
procedure PutImageTransparent(x,y:smallint; var bitmap; transColor:longword); overload;
procedure PutImageTransparent(x,y:smallint; var bitmap);  overload;
...
procedure PutImage(x1,y1:smallint; var bitmap);
begin
...
procedure PutImageTransparent(x,y:smallint; var bitmap; transColor:longword);
var
	hbmp: HBITMAP;
	img : TImage absolute bitmap;
begin
...
procedure PutImageTransparent(x,y:smallint; var bitmap);
var
	hbmp: HBITMAP;
	img : TImage absolute bitmap;
	icolor : longword;
